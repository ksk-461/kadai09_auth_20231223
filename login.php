...
<body>
    <div id="wrap">
        <form class="form_container" action="./login_act.php" method="post">
            <div class="title_container">
                <p class="title">管理者用ログイン画面</p>
                <span class="subtitle">ログインパスワード等失念した場合は、システム担当までお声かけください。</span>
            </div>
            <br>
            <div class="input_container">
                ...
                <input placeholder="name@mail.com" title="Input title" name="lid" type="text" class="input_field" id="email_field">
            </div>
            <div class="input_container">
                ...
                <input placeholder="Password" title="Input title" name="lpw" type="password" class="input_field" id="password_field">
            </div>
            <button title="Sign In" type="submit" class="sign-in_btn">
                <span>ログイン</span>
            </button>
            <p class="note"><a href="./index.php">見積もり依頼フォームはこちら</a></p>
        </form>
    </div>
</body>
</html>